...
public class StoryScreen extends BaseScreen {
    ...
    public void initialize() {
        ...
        continueKey.loadTexture("MissingHomework/V1/key-C.png");
        ...
        theEnd.loadTexture("MissingHomework/V1/the-end.png");
    ...
    public void hallway() {
        ...
        addTextSequence( "I can be a little forgetful sometimes. " +
                "Right now, I'm looking for my homework." );
    ...
    public void scienceLab() {
        ...
        classroomButton.addListener(
                (Event e) -> {
                    ...
                    scene.addSegment( new SceneSegment( buttonTable, Actions.hide() ));
                    addTextSequence( "Maybe someone found it and put it in the classroom. " +
                            "I'll go check." );
